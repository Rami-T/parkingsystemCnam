...
public class DBConstants {
    ...
    public static final String GET_TICKETS_BY_VEHICLE_REG_NUMBER = "select count(*) from ticket t where t.VEHICLE_REG_NUMBER=?";
     public static final String GET_TICKETS_COUNT = "select count(*) from ticket";
